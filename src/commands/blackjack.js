// crime.js - Com formatação brasileira
...
export async function execute(interaction) {
  try {
    ...
    try {
      ...
      conteudo = ganhou
        ? `Você cometeu um crime e lucrou ${formatarDinheiro(Math.abs(valor))}.`
        : `Você tentou cometer um crime, mas foi pego e perdeu ${formatarDinheiro(
            Math.abs(valor)
          )}.`;
    }
